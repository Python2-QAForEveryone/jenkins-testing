...
class URLLocators:
    URL_RIGHT_ARROW = TD.BASE_URL + 'view/all/'
    URL_NEW_ITEM = TD.BASE_URL + 'view/all/newJob'
    URL_PEOPLE = TD.BASE_URL + 'asynchPeople/'
    URL_BUILD_HISTORY = TD.BASE_URL + 'view/all/builds'
    URL_MANAGE_JENKINS = TD.BASE_URL + 'manage'
    URL_MY_VIEW = TD.BASE_URL + 'me/my-views/view/all/'
    URL_LOCKABLE_RESOURCES = TD.BASE_URL + 'lockable-resources/'
    URL_NEW_VIEW = TD.BASE_URL + 'newView'
    URL_FOOTER_REST_API = TD.BASE_URL + 'api/'
    URL_BUILD_EXECUTOR_STATUS = TD.BASE_URL + 'computer/'
...
class EmptyStateBlock:
    ...
    LEARN_MORE_TEXT = (
    By.XPATH, '//a[@href="https://jenkins.io/redirect/distributed-builds"]/span[contains(text(), "Learn more")]')
    LEARN_MORE_SIGN = (
    By.XPATH, '//a[@href="https://jenkins.io/redirect/distributed-builds"]/span[@class="trailing-icon"]')
